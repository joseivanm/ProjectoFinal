...
<nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
    ...
    <div class="container px-4 px-lg-5">
        ...
        <form class="d-md-none me-auto"> <!-- Mostrar a la izquierda del menú burger en dispositivos móviles -->
            ...
            if (isset($_SESSION['usuario'])) {
                ...
                echo '<button class="btn btn-outline-dark text-white" type="button" id="btnVerCarrito1">';
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <li class="nav-item"><a class="nav-link text-white" href="../username/contacto.php">Contacto</a></li>
            ...
            if (isset($_SESSION['usuario'])) {
                ...
                echo '<span id="cart-badge1" class="badge bg-dark text-white ms-1 rounded-pill"></span>';
